...
angular.module('corpusModule')
    .controller('corpusController', function ($scope, $http, $timeout, $modal, $state, infoDataService, historyUrlService) {
        ...
        $scope.gridOptionsAbbr = {
            columnDefs: [
                ...
                },
                {
                    ...
                    cellTemplate: "<div class=\"ui-grid-cell-contents ng-binding ng-scope\" ng-show=\"row.entity.abbr!=='No data'\"><i class=\"iconDef fa fa-pencil-square-o\" ng-click=\"grid.appScope.corpusEdit(row.entity)\"></i></div>", width: '2%'
                },
                {
                    field: 'icons', displayName: '',
                    cellTemplate: "<div class=\"ui-grid-cell-contents ng-binding ng-scope\" ng-show=\"row.entity.abbr!=='No data'\"><i class=\"iconDef iconColorRed fa fa-trash-o\" ng-click=\"grid.appScope.delete(rowRenderIndex,row.entity)\"></i></div>"
                }
            ],
            enableSorting: false,
            ...
            paginationPageSize: infoDataService.pageSize()+1, //每页显示个数
            totalItems: 0, // 总数量
        ...
        $scope.gridOptionsPhrase = {
            columnDefs: [
                ...
                {
                    field: 'icons', displayName: '',
                    cellTemplate: "<div class=\"ui-grid-cell-contents ng-binding ng-scope\" ng-show=\"row.entity.phrase!=='No data'\"><i class=\"iconDef fa fa-pencil-square-o\" ng-click=\"grid.appScope.corpusEdit(row.entity)\"></i></div>", width: '2%'
                },
                {
                    field: 'icons', displayName: '',
                    cellTemplate: "<div class=\"ui-grid-cell-contents ng-binding ng-scope\" ng-show=\"row.entity.phrase!=='No data'\"><i class=\"iconDef iconColorRed fa fa-trash-o\" ng-click=\"grid.appScope.delete(rowRenderIndex,row.entity)\"></i></div>"
                }
            ],
            enableSorting: false,
            enableVerticalScrollbar: 0,
        ...
        var corpus = historyUrlService.getCorpus();
        ...
        $scope.Search = function (flag, index) {
            if ($scope.corpusNavTxt === 'abbreviation_dict') {
                ...
                if (index) {
                    ...
                    queryAbbrCorpus(index, $scope.gridOptionsAbbr.paginationPageSize);
                } else {
                ...
                if (index) {
                    ...
                    queryWordPhraseCorpus(index, $scope.gridOptionsPhrase.paginationPageSize);
                } else {
            ...
            $http({
                ...
                function (data) {
                    if (data && data.data && data.data.content.length > 0) {
                        $scope.gridOptionsAbbr.data = data.data.content;
                        $scope.gridOptionsAbbr.totalItems = data.data.totalElements;
                        $scope.gridOptionsAbbr.paginationCurrentPage = page;
            ...
            $http({
                ...
                function (data) {
                    ...
                    if (data && data.data && data.data.content.length > 0) {
                        $scope.gridOptionsPhrase.data = data.data.content;
                        $scope.gridOptionsPhrase.totalItems = data.data.totalElements;
                        $scope.gridOptionsPhrase.paginationCurrentPage = page;
            ...
            $http({
                ...
                function (data) {
                    if (data && data.data && data.data.content.length > 0) {
                        ...
                        oriScope.gridApiAbbr.pagination.getTotalPages = function () {
                            return data.data.totalPages;
                        }
                    } else {
            ...
            $http({
                ...
                function (data) {
                    if (data && data.data && data.data.content.length > 0) {
                        ...
                        oriScope.gridApiPhrase.pagination.getTotalPages = function () {
                            return data.data.totalPages;
                        }
                    } else {
