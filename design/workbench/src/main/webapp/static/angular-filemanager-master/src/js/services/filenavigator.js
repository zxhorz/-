    ...
    angular.module('FileManagerApp').service('fileNavigator', [
        'apiMiddleware', 'fileManagerConfig', 'item', function (ApiMiddleware, fileManagerConfig, Item) {
            ...
            FileNavigator.prototype.list = function () {
                return this.apiMiddleware.list(this.currentPath, this.runId, this.deferredHandler.bind(this));
            };
            ...
            FileNavigator.prototype.refresh = function () {
                ...
                return self.list().then(function (data) {
                    ...
                    if(data.result[0]){
                        self.parentFolder = data.result[0].parentFolder;
                    }
                    self.buildTree(path);
                    self.onRefresh();
                }).finally(function () {
            ...
            FileNavigator.prototype.outputLink = function (runId) {
                this.runId = runId;
                this.currentPath = this.getBasePath();
                this.refresh();
            };
            FileNavigator.prototype.goBackScript = function () {
                this.currentPath = this.getBasePath();
                this.runId = 0;
                this.refresh();
            };
