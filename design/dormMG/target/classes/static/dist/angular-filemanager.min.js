...
function (e, n) {
    ...
    e.module("FileManagerApp").controller("FileManagerCtrl", ["$scope", "$rootScope", "$window", "$translate", "fileManagerConfig", "item", "fileNavigator", "apiMiddleware", function (e, r, i, a, t, o, s, l) {
        ...
        }, e.openEditDocumentItem = function () {
            var r = e.singleSelection(),
                i = {
                    url: e.apiMiddleware.getUrl(r),
                    filename: r.model.name
                },
                a = [e.config.documentViewUrl, n.param(i)].join("?");
            n("#iframeEditor").attr("src", a), e.modal("editDoc")
...
function (e) {
    ...
    e.module("FileManagerApp").factory("item", ["fileManagerConfig", "chmod", function (n, r) {
        ...
        }, i.prototype.isDocument = function () {
            return !this.isFolder() && n.isDocumentFilePattern.test(this.model.name)
...
function (e) {
    ...
    e.module("FileManagerApp").provider("fileManagerConfig", function () {
        var n = {
            ...
            isExtractableFilePattern: /\.(gz|tar|rar|7z|g?zip)$/i,
